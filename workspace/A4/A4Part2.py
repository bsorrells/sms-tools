...
if __name__ == "__main__":
    ...
    pianoSNR = computeSNR(os.path.join(sound_dir, "piano.wav"),            "blackman", 513,  2048, 128)
    saxSNR   = computeSNR(os.path.join(sound_dir, "sax-phrase-short.wav"), "hamming",  512,  1024, 64 )
    rainSNR  = computeSNR(os.path.join(sound_dir, "rain.wav"),             "hann",     1024, 2048, 128)

    print("Test1: ", pianoSNR)
    print("Test2: ", saxSNR)
    print("Test3: ", rainSNR)